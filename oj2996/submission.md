...
```text
โจทย์ให้ฉันรับข้อความที่มีความยาว 5 ตัวอักษร แล้วทำการสลับเปลี่ยนจากข้างหน้าไปข้างหลัง

Input:
โปรแกรมรับชื่อยาว 5 ตัวอักษร

Output:
โปรแกรมควรจะพิมพ์ชื่อตาม Input แต่สลับโดยให้เรียงจากหลังไปหน้า เป็นตัวพิมพ์เล็ก

Constraints:
ไม่มี เพราะตัว input ไม่ได้จำกัดอักษรใดๆ
```
...
```text
Step 1:รับชื่อจาก Input เป็น string
Step 2:สลับ index ของ string ด้วย [::-1] เพื่อให้ไล่ตัวอักษรจากหลังสุด
Step 3:ใช้ .lower() เพื่อทำให้แน่ใจว่าจะเป็นพิมพ์เล็กทั้งหมด
Step 4:แสดงค่า
```
...
```text
วิธีสุดท้ายของฉันเหมือนกับแผนแรก ฉันนำ Step ที่ 2-4 มารวมกันในบรรทัดเดียว หลังจากรับค่ามาแล้ว สลับตัวอักษร ใช้ .lower() เพื่อให้แน่ใจและจึงแสดงผลออกมา
```
...
```text
เพื่อเช็คว่าคำสั่ง [::-1] ที่ใช้ จำเกิด Error ไหม
```
...
```text
เพื่อเช็คว่าเลือกชนิดตัวแปรมาถูกไหม
```
