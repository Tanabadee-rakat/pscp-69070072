...
```text
โจทย์ให้รับค่าอุณหภูมิมา 1 หน่วย แล้วให้แปลงเป็นอีกหน่วยตามที่ให้มา

Input:
บรรทัด 1 :รับค่าอุณหภุมิ, บรรทัด 2 :หน่วยองศาของค่าที่ให้มา, บรรทัด 3: หน่วยองศาที่ต้องการ

Output:
ค่าองศาในหน่วยที่โจทย์ต้องการ เป็นทศนิยม 2 ตำแหน่ง

Constraints:
ต้องเปลี่ยนองศาที่ได้มาให้เป็น celsius ก่อนถึงจะสามารถแปลงเป็นหน่วยอื่นๆต่อได้
```
...
```text
Step 1: รับค่าอุณหภูมิ, หน่วยของอุณหภูมิบรรทัดที่ 1, หน่วยของอุณหภูมิที่ต้องการ
Step 2: เปลี่ยนหน่วยของค่าอุณหภูมิที่ได้ให้เป็น celsius ก่อน โดยใช้ match case เช็คหน่วย
Step 3: เปลี่ยนค่าที่ได้ให้เป็นค่าที่ต้องการ โดยใช้ match case เช็คหน่วย และพิมพ์ค่า
```
...
```text
วิธีสุดท้ายฉันใช้เหมือนกับแผนแรก ฉันสร้างฟังก์ชันที่ใช้ในการแปลงเป็น Celsius ก่อน แล้วนำตัวแปรที่ได้มาไปเข้าสูตรที่โจทย์ได้ให้มา หลังจากนั้นค่อยกลับมาแปลงเป็นหน่วยที่โจทย์ต้องการอีกที และทำให้เป็นทศนิยม 2 ตำแหน่ง
```
...
```text
เพิ่อเช็คสมการที่ใช้ในการแปลงหน่วยจาก Celsius เป็น Rankine
```
...
```text
เพิ่อเช็คสมการขององศา Fahrenheit และตรวจว่าถ้าคำตอบเป็น 0.xx แล้วจะมี bug หรือ error ไหม
```
...
```text
เพื่อเช็คการเปลี่ยนค่าระหว่างหน่วย K ไปหน่วย F 
```
