...
```text
โจทย์ให้ฉันรับจำนวนเงินรวมแล้วนำมาคิดค่าบริการ และ VAT

Input:
รับเงินค่าอาหารทั้งหมดเป็นจำนวนเต็ม

Output:
พิมพ์ราคาอาหารที่ได้ถูกคิดรวมค่าบริการและ VAT แล้วโดยแสดงเป็นทศนิยมสองหลัก

Constraints:
ค่าบริการคิดเป็น 10% ก็จริง แต่ต้องคิดอย่างน้อย 50 บาท และไม่เกิน 1000 บาท แล้วจึงค่อยคิด VAT
```
...
```text
Step 1:รับค่าจำนวนเงินค่าอาหาร เป็นจำนวนเต็ม
Step 2:ตรวจว่า 10% ของ ราคาอาหารเกิน 50 บาทไหม
Step 3:ถ้าเกินก็บวก 50 บาท ไปในค่าบิล
Step 4:ตรวจว่า 10% อยู่ระหว่าง 1000 และ 50 ไหม
Step 5:ถ้าอยู่ระหว่างให้นำมาบวกกับค่าบิล
Step 6:ตรวจว่า 10% เกิน 1000 บาท ไหม
Step 7:ถ้าเกินให้นำ 1000 ไปบวกค่าบิล
Step 8: นำค่าบิลไปรวมกับค่า VAT 7% จากบิลที่คิดมาแล้วพิมพ์ค่าบิล
```
...
```text
วิธีสุดท้ายฉันใช้เหมือนกับแผนแรก ฉันนำค่าบิลไปตรวจเช็คเพื่อหาค่าบริการให้ได้ก่อนแล้วจึงค่อยนำไปคิดค่า VAT 7% เอาไปรวมกับบิลหลักและพิมพ์ออกมา
```
...
```text
เพื่อตรวจสอบว่าถ้าค่าอาหารเป็น 0 โค้ดยังคิดค่าบริการถูกต้องไหม
```
...
```text
เพื่อตรวจสอบเงื่อนไขที่ 10% มากกว่า 50 และน้อยกว่า 1000
```
...
```text
เพื่อตรวจในเงื่อนไขที่ค่าบริการเกิน 10% ของค่าบิล
```
